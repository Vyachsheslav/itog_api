...
class YandexDisk:
    ...
    def upload_file_to_disk(self):        
        ...
        headers = self.get_headers()
        upload_url = 'https://sun4-17.userapi.com/impf/byTiuiCzlcw-7HQqNI8VeOhaKVPrGm-Sdt9wsQ/banGDBotKVM.jpg?size=731x1000&quality=96&sign=432b2466a268e6e51f46eb47c80ce26a&c_uniq_tag=IraiqwN4-ugqtJPjK4lTRIFF5_YM2KEiJGJmVi9HjtY&type=album'
        response = requests.post(headers=headers, url=upload_url)
